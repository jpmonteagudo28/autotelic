...
Initially, had trouble seeing that I needed to use the law of total probability to get the total, unconditioned probability of twins $P(T)$. Once I figured that out, finding the probability of a second twin birth $P(T_{2}|T_{1})$ was easy.
